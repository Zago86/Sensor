...
namespace Sensor
{
    public class ConnectedDevices
    {
        ...
        string szPathFileConnection = @"..\..\..\Connection\ ";
        ...
        {           
            ...
            MainWindow.logger.Debug("{0}, {1}, {2}", e.ChangeType, e.FullPath, TotaldeviceConnected.Count);
        }        
        ...
        private void OnCreated(object sender, FileSystemEventArgs e)
        {
            try
            {
                ...
                MainWindow.DataBase.CreateAllTableOnDB();
                ConnectionSetAndOpen.OpenConnection();
                MainWindow.logger.Debug("{0}, {1}, {2}", e.ChangeType, e.FullPath, TotaldeviceConnected.Count);
